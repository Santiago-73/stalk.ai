...
import { Eye, LayoutDashboard, FileText, Settings, LogOut, Building2, TrendingUp, Users } from 'lucide-react'
import { logout } from '@/app/(auth)/actions'

const navItems = [
    { href: '/dashboard', icon: <LayoutDashboard size={18} />, label: 'Dashboard' },
    { href: '/dashboard/subjects', icon: <Building2 size={18} />, label: 'Subjects' },
    { href: '/dashboard/trends', icon: <TrendingUp size={18} />, label: 'Trends' },
    { href: '/dashboard/channels', icon: <Users size={18} />, label: 'Channels' },
